    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="category-box p-3 mb-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="#">Quạt điện</a></li>
                    <li class="list-group-item"><a href="#">Bếp điện</a></li>
                    <li class="list-group-item"><a href="#">Nồi cơm điện</a></li>
                    <li class="list-group-item"><a href="#">Đèn điện</a></li>
                    <li class="list-group-item"><a href="#">Dụng cụ nhà bếp</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-9">
            ...
            <div class="sanpham-container">
                ...
                $sql = "SELECT * FROM products ORDER BY id DESC LIMIT $offset, $products_per_page";
